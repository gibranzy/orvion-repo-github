...
<head>
    ...
    <title>Daftar Akun - Orvion Mart</title>
...
<body class="gradient-bg min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
    ...
    <!-- Register Card -->
    <div class="register-card rounded-3xl w-full max-w-md relative z-10 overflow-hidden">
        ...
        <div class="p-8 sm:p-10">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-gray-500 text-sm">Bergabung dengan Orvion Mart sekarang</p>
            </div>

            <!-- Validation Errors -->
            @if ($errors->any())
                <div class="mb-6 p-3 bg-red-50 border border-red-200 text-red-700 rounded-xl text-sm">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-4">
                ...
                <div class="flex items-start">
                    <input id="terms" type="checkbox" name="terms" 
                           class="checkbox-custom w-4 h-4 mt-1 rounded border-gray-300">
                    <label for="terms" class="ms-2 text-sm text-gray-600 cursor-pointer">
                        Saya setuju dengan <a href="#" class="text-indigo-600 hover:text-indigo-800 font-medium">Syarat & Ketentuan</a> serta <a href="#" class="text-indigo-600 hover:text-indigo-800 font-medium">Kebijakan Privasi</a> Orvion Mart
                    </label>
                </div>

                <!-- Register Button -->
                <button type="submit" class="btn-register w-full text-white font-semibold py-3.5 rounded-xl shadow-lg flex items-center justify-center gap-2 text-base">
