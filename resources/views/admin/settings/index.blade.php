    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-xl shadow-sm border overflow-hidden sticky top-20">
                <nav class="p-2">
                    <a href="#notifications" class="settings-nav block px-4 py-3 text-indigo-600 bg-indigo-50 rounded-lg font-medium mb-1">
                ...
                <form action="{{ route('admin.settings.store') }}" method="POST" class="space-y-4">
                    ...
                    <div class="space-y-3">
                        <label class="flex items-start p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition cursor-pointer">
                            ...
                            <input type="checkbox" name="email_notifications" value="1" {{ (isset($settings['email_notifications']) && $settings['email_notifications']) || !isset($settings['email_notifications']) ? 'checked' : '' }}
                        ...
                        <label class="flex items-start p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition cursor-pointer">
                            ...
                            <input type="checkbox" name="push_notifications" value="1" {{ (isset($settings['push_notifications']) && $settings['push_notifications']) || !isset($settings['push_notifications']) ? 'checked' : '' }}
                                   class="w-5 h-5 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500 mt-0.5">
                            <div class="ml-3 flex-1">
            ...
            <div id="security" class="bg-white p-6 rounded-xl shadow-sm border">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                        ...
                        <a href="{{ route('profile.edit') }}" class="px-4 py-2 border border-indigo-600 text-indigo-600 rounded-lg hover:bg-indigo-50 transition">
                            Ubah Password
                        </a>
                    </div>
                ...
                <form action="{{ route('admin.settings.store') }}" method="POST" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="language" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none">
                        ...
                        <div>
                            ...
                            <select name="timezone" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none">
